...
public class FAQ extends javax.swing.JFrame {
    ...
    public FAQ(user user, ArrayList<user> allUsers){
        this.user = user;
    ...
    private void initComponents() {
        ...
        llAsnwerCont2 = new javax.swing.JLabel();
        ...
        lblTitle.setText("Frequently Asked Questions | TBS");

        lblQ1.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        lblQ1.setText("1. How can I transfer money from one account to another?");

        lblAnswer1.setText("*To transfer money, log into your TBS account -> move money -> select account and transfer amount -> send");

        lblQ2.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        lblQ2.setText("2. Why is my card number not working?");

        lblAnswer2.setText("This may be due to a variety of reasons including typos, incorrect data transfer, etc.");

        llAsnwerCont2.setText("*Ensure that you have signed up through our sign up page so that we have your account in our database.");

        lblQ3.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        lblQ3.setText("3. What do I do if i forgot my password?");

        lblAnswer3.setText("*If you forgot your password, go to the TBS sign in page -> Forgot Password -> answer security question -> reset");

        lblQ4.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        lblQ4.setText("4. What happens if I lose my account number?");
    ...
    private void btnHomeActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        HomePage newFrame = new HomePage(accountInfo, index);
    ...
    private javax.swing.JLabel llAsnwerCont2;
